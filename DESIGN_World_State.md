...
- **Экран "читать воспоминание"** — v1 пишет текст в `UE_LOG`
  (`ShowZaryanaStatus`), не в игровой UI. Полноценный экран — следующий шаг
  того же рода, что подсветка закономерностей Травника.
