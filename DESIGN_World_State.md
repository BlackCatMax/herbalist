...
### 39. Отдельно, ещё не решено — стимул держать биом заражённым

Второй вопрос сессии (яды как причина не чинить биом) — согласились, что
нужен, но не реализован. Готовый рычаг уже есть: осквернение капища
(`Restoration < 0`, §15.5) сейчас не даёт игроку ничего, кроме отсутствия
вреда — не хватает **пользы** от активного поддержания порчи (потенция/
редкость ядовитых ингредиентов, растущая с глубиной Corruption клетки).
