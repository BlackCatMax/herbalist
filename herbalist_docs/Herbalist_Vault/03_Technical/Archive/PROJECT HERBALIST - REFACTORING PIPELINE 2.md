> ⚠️ **АРХИВ / УСТАРЕЛ (перенесено в архив 2026-08-30).**
> Раздел «Фактический статус реализации» ниже последний раз сверялся с кодом
> 2026-08-12 — до всей ветки аудитов конца августа, и с тех пор не обновлялся.
> Текущий рабочий план — `AUDIT_AND_REFACTORING_PLAN.md`, текущая летопись
> изменений — `CHANGELOG.md` (оба в корне проекта). Документ ниже сохранён
> как исторический архитектурный артефакт (формальная алгебра команд,
> тиковая модель — многое из этого реально легло в основу `PipelineV2`),
> не как источник истины о текущем состоянии.
