...
enum class ECommandPrimitive : uint8
{
    ...
    // читает Molva/Respect и реестр диалогов (Core/Dialogue/
    // HerbalistDialogueTypes.h, с 2026-09-02 — DT_Dialogue, не литеральный
    // массив в C++), ничего не меняет в FRealState/инвентаре, поэтому не
