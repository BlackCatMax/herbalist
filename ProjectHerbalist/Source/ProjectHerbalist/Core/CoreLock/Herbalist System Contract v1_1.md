...
> ⚠️ **АРХИВ / УСТАРЕЛ (зафиксировано аудитом 2026-08-12).**
> Этот документ описывает архитектуру (`FAlchemyAtom`, `SemanticResolver`, `IntentResolver`,
...
> здесь только как исторический дизайн-артефакт; их чек-маркам «✅ реализовано» ниже доверять нельзя.

**Дата:** 24.04.2026
**Статус:** ~~Принят как reference для всех фаз реализации~~ Архивирован, заменён Refactoring Pipeline 2
