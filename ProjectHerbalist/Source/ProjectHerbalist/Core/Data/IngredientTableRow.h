...
struct PROJECTHERBALIST_API FIngredientTableRow : public FTableRowBase
{
    ...
    // Речная пойма (11), Смешанный лес (10) и Тайга (10) проверены и
    // размечены (см. ingredient_gathering_and_garden_flags.json) -- ни
    // одного мотива для bIronAverse/bDelicate ни в одном из пяти не
    // нашлось, только GardenNiche. Деревья/кустарники сознательно БЕЗ
    // ниши повсюду (Ива/Ольха/Калина/Смородина/Берёза/Осина/Лещина/Сосна/
    // Пихта/Можжевельник/Жимолость) -- все 5 ниш описаны как малые
    // постройки под траву/гриб, ни одного прецедента с многолетним кустом/
    // деревом/ягодным кустарничком нет.
    // Оставшиеся 2 биома (Широколиственный лес/Болото) -- впереди.
