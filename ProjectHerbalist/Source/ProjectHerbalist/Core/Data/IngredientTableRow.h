...
struct PROJECTHERBALIST_API FIngredientTableRow : public FTableRowBase
{
    ...
    // ни в одной (в т.ч. ягодные кустарнички Водяника/Княженика/Морошка --
    // тот же морфологический тип, что и Брусника/Черника Тайги ниже, оба
    // раза без ниши, для консистентности). Степь (8), Лесостепь (9),
    // Речная пойма (11), Смешанный лес (10), Тайга (10) и Широколиственный
    ...
    // из шести не нашлось, только GardenNiche. Деревья/кустарники
    // сознательно БЕЗ ниши повсюду (Ива/Ольха/Калина/Смородина/Берёза/
    // Осина/Лещина/Сосна/Пихта/Можжевельник/Жимолость/Дуб/Клён/Липа) --
    // все 5 ниш описаны как малые постройки под траву/гриб, ни одного
    // прецедента с многолетним кустом/деревом/ягодным кустарничком нет.
    // Кора (broad_10, продукт дерева-донора) -- та же граница, новый
    // случай: собственной ниши у продукта с дерева нет и не может быть.
    // Остался 1 биом (Болото, 12 карточек) -- впереди.
