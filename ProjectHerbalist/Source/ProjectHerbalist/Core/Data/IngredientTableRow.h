...
struct PROJECTHERBALIST_API FIngredientTableRow : public FTableRowBase
{
    ...
    // ни в одной. Степь (8) и Лесостепь (9) проверены и размечены (см.
    // ingredient_gathering_and_garden_flags.json) -- ни одного мотива для
    // bIronAverse/bDelicate в обоих не нашлось, только GardenNiche.
    // Оставшиеся 5 биомов (Речная пойма/Смешанный лес/Тайга/
