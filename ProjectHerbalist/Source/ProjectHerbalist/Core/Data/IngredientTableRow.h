...
struct PROJECTHERBALIST_API FIngredientTableRow : public FTableRowBase
{
    ...
    // ни в одной. Степь (8 карточек) проверена и размечена (см.
    // ingredient_gathering_and_garden_flags.json) -- ни одного мотива для
    // bIronAverse/bDelicate тоже не нашлось, только GardenNiche.
    // Оставшиеся 6 биомов (Лесостепь/Речная пойма/Смешанный лес/Тайга/
    // Широколиственный лес/Болото) -- впереди.
