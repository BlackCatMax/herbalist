...
struct FAmbientSpawnerRuntime
{
    ...
    // Сколько раз подряд точку появления отклонили обереги (ревью
    // 2026-09-20). Входит в сид следующей точки: без этого спавнер пробовал
    // бы ОДНУ И ТУ ЖЕ точку, и оберег, накрывший её краем, глушил бы всю
    // зону целиком, пока не кончится.
    int32 RejectedSpawnAttempts = 0;
