...
void AGridWorldManager::UpdateEntityManifestations(float DeltaTime)
{
    ...
    {
        // Стриминг сетки (2026-09-03): проявления считаются только в
        // активных чанках. Правило "пока чанк неактивен, сущности в нём не
        // проявляются и не гаснут" осознанное: триггеры путь-зависимы
        // (гистерезис), догнать их одним шагом нельзя, а «никто не видел —
        // ничего и не проявилось» согласуется с дизайном ранга.
