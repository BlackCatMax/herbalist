...
void AGridWorldManager::InitializeCells()
{
    ...
    // Курганы (§2.3/§4.3, 2026-09-06) — детерминированная расстановка тем же
    // WorldRNG, что уже вода/ресурсы выше в этой функции; ДО CellBaselines
    // ниже, тот же довод: baseline должен увидеть уже финальную, а не
    // частично засеянную сетку (сами курганы не трогают Cell.State, но
    // порядок здесь общий принцип для всего в этой функции).
    SeedKurganSites();
